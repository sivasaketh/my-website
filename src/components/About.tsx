        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6">
            {stats.map(({ value, label }) => (
              <div
                key={label}
                className="bg-gray-900 border border-white/5 rounded-xl p-5 sm:p-6 text-center hover:border-indigo-500/30 transition-colors"
              >
                <p className="text-3xl sm:text-4xl font-bold text-indigo-400 mb-1">{value}</p>
